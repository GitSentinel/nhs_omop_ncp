...
Provides LangChain tools for validating the project, running approved pipeline stages, selecting GPUs, collecting logs/artifacts, and extracting evaluation metrics for the final structured report.
"""
...
def required_steps_for_target(
    ...
    """Return the ordered pipeline steps for a target and mode."""

# Agentic Pipeline Report — 20260804T141204Z

- Target: `original`
- Mode: `post-finetune`
- Started: `2026-08-04T14:12:04.619251+00:00`
- Finished: `2026-08-04T14:16:43.711779+00:00`
- Training GPUs: `[]`
- Evaluation GPU: `0`
...
Synthetic pipeline assessment (original binary treatment-event task, post-finetune). The evaluation ran original_evaluate on the original dataset. Baseline (base) test metrics: f1=0.7831, macro_f1=0.4864, accuracy=0.6578, balanced_accuracy=0.5366, precision=0.6607, recall=0.961, roc_auc=0.6214, pr_auc=0.7948. Finetuned test metrics: f1=0.9010, macro_f1=0.8397, accuracy=0.8631, balanced_accuracy=0.8209, precision=0.8420, recall=0.9688, roc_auc=0.9564, pr_auc=0.9727. Delta (finetuned - base): f1 +0.1179; macro_f1 +0.3533; accuracy +0.2053; balanced_accuracy +0.2843; precision +0.1813; recall +0.0078; roc_auc +0.3350; pr_auc +0.1779. False negatives: base FN=15; finetuned FN=12. Overall, the finetuned model shows substantial improvements across macro F1, PR AUC, ROC AUC, and most accuracy-related metrics on the original test split, with a modest change in recall. These results are reported for synthetic research and require human review.
...
| original_evaluate | original | succeeded | 248.4 | 0 |
...
- Baseline (original base, test split): f1=0.7831, macro_f1=0.4864, accuracy=0.6578, balanced_accuracy=0.5366, precision=0.6607, recall=0.961, roc_auc=0.6214, pr_auc=0.7948.
- Finetuned (original finetuned, test split): f1=0.9010, macro_f1=0.8397, accuracy=0.8631, balanced_accuracy=0.8209, precision=0.8420, recall=0.9688, roc_auc=0.9564, pr_auc=0.9727.
- Improvement deltas (finetuned - base): f1 +0.1179, macro_f1 +0.3533, accuracy +0.2053, balanced_accuracy +0.2843, precision +0.1813, recall +0.0078, roc_auc +0.3350, pr_auc +0.1779.
- False negatives (base vs finetuned): 15 vs 12.

## Safety flags

- Synthetic data; results intended for research purposes and require human review.

## Recommended actions

- Proceed to external validation on additional synthetic data to assess generalizability.
- Document thresholds and operating points used for finetuned model.
- Prepare a human review plan for model deployment in synthetic research context.
...
[
  ...
  },
  {
    ...
    "source": "/home/jacinth/nhs_omop_ncp/data/pipeline_runs/20260804T141204Z/original_evaluate.log"
  },
  {
    "dataset": "original",
    "model": "fine_tuned",
